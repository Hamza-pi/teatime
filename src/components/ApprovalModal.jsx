...
const ApprovalModal = ({ setModal }) => {
	...
	return (
		<div className="sm:max-w-3xl m-auto bg-lightDark rounded-xl p-4 flex sm:flex-row flex-col items-center  justify-center gap-4 relative mt-16">
			{/* Icon */}
			<MdOutlineCancel
			...
			{/* Info Side */}
			<div className="pr-4 flex flex-col  justify-between p-4">

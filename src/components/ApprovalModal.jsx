...
const ApprovalModal = ({ setModal }) => {
  ...
  return (
    <div className="sm:max-w-3xl m-auto bg-lightDark rounded-xl p-3 flex sm:flex-row flex-col items-center justify-center gap-4 relative mt-8">
      {/* Icon */}
      <MdOutlineCancel
        className="absolute top-1 right-1 text-btnFrom text-3xl cursor-pointer"

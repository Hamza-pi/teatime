			...
			<div className=" flex flex-col">
				<div className="font py-10 flex flex-col">
					...
					<div className="w-fit mt-1">
						...
						<p className="text-sm text-[#F5E65F] font-bold">BINGO</p>
					</div>
					<div className="flex justify-between">
						<p className="text-xs text-[#D9D9D9]">@ The Ballroom</p>
						<div className="">
							<p className="text-sm text-[#F5E65F]">Tue 26th Sep</p>
							<div className="bg-[#F5B05FD9]  p-[1px] rounded-2xl"></div>
							<p className="text-sm text-[#F5E65F] font-bold">Afternoon Tea</p>
						</div>
					</div>
					<div className="flex justify-between">
						{' '}
						<div className="">
							<p className="text-sm text-[#F5E65F]">Wed 27th Sep</p>
							<div className="bg-[#F5B05FD9]  p-[1px] rounded-2xl"></div>
							<p className="text-sm text-[#F5E65F] font-bold">Bus Trip</p>
						</div>
					...
					<div className="flex justify-between">
						...
						<div className="">
							<p className="text-sm text-[#F5E65F]">Thu 28th Sep</p>
							<div className="bg-[#F5B05FD9]  p-[1px] rounded-2xl"></div>
							<p className="text-sm text-[#F5E65F] font-bold">Dance Classes</p>
						</div>
					</div>
					<div className="flex justify-between">
						{' '}
						<div className="">
							<p className="text-sm text-[#F5E65F]">Fri 29th Sep</p>
							<div className="bg-[#F5B05FD9]  p-[1px] rounded-2xl"></div>
							<p className="text-sm text-[#F5E65F] font-bold">Happy hour</p>
						</div>
						<p className="text-xs text-[#D9D9D9]">@ The Ballroom</p>
					</div>
					<div className="flex justify-between">
						...
						<div className="">
							<p className="text-sm text-[#F5E65F]">Sat 30th Sep</p>
							<div className="bg-[#F5B05FD9]  p-[1px] rounded-2xl"></div>
							<p className="text-sm text-[#F5E65F] font-bold">Pet Therapy</p>
						</div>
					</div>
					<div className="flex justify-between">
						{' '}
						<div className="">
							<p className="text-sm text-[#F5E65F]">Sun 31st Sep</p>
							<div className="bg-[#F5B05FD9]  p-[1px] rounded-2xl"></div>
							<p className="text-sm text-[#F5E65F] font-bold">Family Funday</p>
